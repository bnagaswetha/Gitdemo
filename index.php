...
<html>
    ...
    <body bgcolor="whitesmoke">      
        ...
        <ul class="normal">
        <li><h1 style="color:white"><b>Welcome To Exam Portal</b></h1></li>
        </ul>
        <ul>
            <li><a class="active" href="#home"><b>HomePage</b></a></li>
